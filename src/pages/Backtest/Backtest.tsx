...
import { Col, Row, Stack, OverlayTrigger, Popover, PopoverBody, Modal, Form, Dropdown } from 'react-bootstrap'
          ...
          <Col md={6} xxl={4} className="p-3">
            <div className='border p-4 rounded-4'>
              ...
              >
                ...
                <DropdownButton id="dropdown-basic-button" title="...">
                  <Dropdown.Item href="#/action-1">
                    <NavLink className="text-decoration-none" to="/backtest-detail">
                      Backtest Detail
                    </NavLink>
                  </Dropdown.Item>
                  <Dropdown.Item onClick={handleModalShow} href="#/action-2">Create Backtest</Dropdown.Item>



                </DropdownButton>
                <OverlayTrigger trigger={["focus"]} overlay={popover} placement="top-start">
              ...
              >
                ...
                <button className={`btn btn-sm px-4 py-2  ${item.isActive ? 'btn-active-emphasis' : 'btn-passive-emphasis'
                  }`} type="button">
                  <span className={`rounded-circle p-1  me-2  ${item.isActive ? 'bg-active-emphasis' : 'bg-passive-emphasis'
                    }`}></span>
        ...
        <Modal.Body>
          <Form style={{ width: 300 }}>
            ...
            <div className='strategy-card-buttons d-flex justify-content-between mt-5'>
              ...
              <button onClick={handleModalClose} className="btn btn-sm px-5  py-2 btn-danger" type="button">
                Cancel
              </button>
            </div>
          </Form>
