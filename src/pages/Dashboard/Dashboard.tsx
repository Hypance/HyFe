                        ...
                        <Row>
                            <Col sm={3}>
                                <div className='border p-4 rounded-4 mt-4'>
                                    ...
                                    <Graph stock={DashboardGrap[0].Graph} color={'#09BD3C'} width={150} height={100}></Graph>
                                    <div className='d-flex mt-4 justify-content-center'>
                                        <img className='my-auto' height={40} src={DashboardGrap[0].Coin.Image} alt="" />
                                        <div >
                                            <p className='card-title ms-3 fw-semibold'>{DashboardGrap[0].Coin.Name}</p>
                                            <p className={`ms-3 ${DashboardGrap[0].Profit > 0 ? 'text-success' : 'text-danger'} fw-semibold`}>{DashboardGrap[0].Profit}</p>
                                        </div>
                                    </div>
                                </div>
                            </Col>
                        ...
                        <div className='border p-4 rounded-4 '>
                            ...
                            <div className='mt-4 '>
                                <div className='d-flex '>
                                    ...
                                    <div className='ms-3'>
                                        <p>Buy Bitcoin</p>
                                        <p>22 August 2022,19.32 PM</p>

                                    </div>
                                    <div className='ms-auto'>
                                        <p>0.221 BTC</p>
                                        <p className='float-end'>$398.36</p>
                                    </div>
                                </div>
                            </div>
                            <hr className='mt-2' />
